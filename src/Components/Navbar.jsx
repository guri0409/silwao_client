   ...
   <>
    <div className='bg-blue-500 h-14 flex justify-center items-center gap-1'>
        ...
        <ul className='flex justify-between gap-1 px-2 items-center bg-gray-500 h-14 space-x-10 text-white'>
            <li><Link to="/"><img src={house} alt="" srcset="" className='w-36 h-12'/></Link></li>
            <li ><Link to="/profile"><img src={woman} className='w-36 h-12' alt="" srcset="" /></Link></li>
            <li><Link to="/notification"><img src={bell} className='h-12 w-36' alt="" /></Link></li>
            <li><Link to="/cart"><img src={onlineshoping} className='h-12 w-36' alt="" /></Link></li>
