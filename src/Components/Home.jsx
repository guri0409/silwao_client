...
export default function Home() {
  return (
    <>
    <Navbar/>
    <div className='flex justify-center mt-8 items-center gap-6 overflow-auto p-10 max-w-screen-sm'>
        <Link to="/product-detail">
        <div className='flex flex-col items-center border gap-2'>
            <img src={one} className='h-36 w-[100%] md:h-72 md:w-80 text-center' alt="" srcset="" />
       ...
       <Link>
       <div className='flex flex-col items-center border gap-2'>
            <img src={two} className='h-36 w-36
             md:h-72 md:w-80' alt="" srcset="" />
            <h2 className='text-1xl font-semibold'>PatialaShahi Suit</h2>
      ...
      <Link>
      <div className='flex flex-col items-center border gap-2'>
            <img src={three} className='h-36 w-36
             md:h-72 md:w-80' alt="" srcset="" />
            <h2 className='text-1xl font-semibold'>PatialaShahi Suit</h2>
            <h6>Price: <span>1199/- Rs.</span></h6>
        </div>
